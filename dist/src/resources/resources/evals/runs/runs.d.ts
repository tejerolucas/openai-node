...
import { OutputItemListParams, OutputItemListResponse, OutputItemListResponsesPage, OutputItemRetrieveResponse, OutputItems } from './output-items';
...
export interface RunCreateResponse {
     ...
     */
    data_source: CreateEvalJSONLRunDataSource | CreateEvalCompletionsRunDataSource | RunCreateResponse.Completions;
    /**
     * An object representing an error response from the Eval API.
     */
    error: EvalAPIError;
...
export interface RunRetrieveResponse {
     ...
     * Information about the run's data source.
     */
    data_source: CreateEvalJSONLRunDataSource | CreateEvalCompletionsRunDataSource | RunRetrieveResponse.Completions;
    /**
     * An object representing an error response from the Eval API.
     */
    error: EvalAPIError;
...
export interface RunListResponse {
     ...
     * Information about the run's data source.
     */
    data_source: CreateEvalJSONLRunDataSource | CreateEvalCompletionsRunDataSource | RunListResponse.Completions;
    /**
     * An object representing an error response from the Eval API.
     */
    error: EvalAPIError;
...
export interface RunCancelResponse {
     ...
     * Information about the run's data source.
     */
    data_source: CreateEvalJSONLRunDataSource | CreateEvalCompletionsRunDataSource | RunCancelResponse.Completions;
    /**
     * An object representing an error response from the Eval API.
     */
    error: EvalAPIError;
