...
function decodeChunks(chunks, { flush } = { flush: false }) {
...
describe('line decoder', () => {
    ...
    test('multi-byte characters across chunks', () => {
        ...
        expect(decoder.decode(new Uint8Array([0xb2, 0xd0, 0xb5, 0xd1, 0x81, 0xd1, 0x82, 0xd0, 0xbd, 0xd0, 0xb8]))).toHaveLength(0);
