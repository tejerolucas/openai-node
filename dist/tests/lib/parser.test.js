...
describe('.parse()', () => {
    describe('zod', () => {
        it('deserialises response_format', async () => {
            const completion = await makeSnapshotRequest((openai) => openai.beta.chat.completions.parse({
      ...
      `);
        ...
        test('merged schemas', async () => {
            ...
            const contactPersonSchema = z.object({
                person1: personSchema.merge(z.object({
                    roles: z
                ...
                person2: personSchema.merge(z.object({
      ...
      `);
            const completion = await makeSnapshotRequest((openai) => openai.beta.chat.completions.parse({
                ...
                messages: [
                    ...
                    {
                        role: 'user',
                        content: 'jane doe, born nov 16, engineer at openai, jane@openai.com. john smith, born march 1, enigneer at openai, john@openai.com',
                    },
                ],
      ...
      `);
        ...
        test('nested schema extraction', async () => {
            ...
            const metadata = z.nullable(z.object({
                foo: z.string(),
            }));
            // union element a
      ...
      `);
        ...
        test('recursive schema extraction', async () => {
            ...
            const linkedListNodeSchema = baseLinkedListNodeSchema.extend({
