...
describe('partial parsing', () => {
    test('should parse complete json', () => {
        ...
        fc.assert(fc.property(fc.json({ depthSize: 'large', noUnicodeString: false }), (jsonString) => {
    ...
    test('should only throw errors parsing numbers', () => fc.assert(fc.property(fc.json({ depthSize: 'large', noUnicodeString: false }), (jsonString) => {
