...
describe('streaming decoding', () => {
    test('basic', async () => {
        ...
        const stream = _iterSSEMessages(new Response(await iteratorToStream(body())), new AbortController())[Symbol.asyncIterator]();
...
async function iteratorToStream(iterator) {
    const parts = [];
