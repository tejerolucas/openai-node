...
describe('resource threads', () => {
    ...
    test('create: request options instead of params are passed correctly', async () => {
        ...
        await expect(client.beta.threads.create({ path: '/_stainless_unknown_path' })).rejects.toThrow(OpenAI.NotFoundError);
    });
    ...
    test('retrieve: request options instead of params are passed correctly', async () => {
        // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
        await expect(client.beta.threads.retrieve('thread_id', { path: '/_stainless_unknown_path' })).rejects.toThrow(OpenAI.NotFoundError);
    });
    test('update', async () => {
    ...
    test('del: request options instead of params are passed correctly', async () => {
        // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
        await expect(client.beta.threads.del('thread_id', { path: '/_stainless_unknown_path' })).rejects.toThrow(OpenAI.NotFoundError);
    });
