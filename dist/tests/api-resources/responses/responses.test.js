...
describe('resource responses', () => {
    ...
    test('retrieve: request options and params are passed correctly', async () => {
        // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
        await expect(client.responses.retrieve('resp_677efb5139a88190b512bc3fef8e535d', { include: ['file_search_call.results'] }, { path: '/_stainless_unknown_path' })).rejects.toThrow(OpenAI.NotFoundError);
    });
    test('del', async () => {
    ...
    test('del: request options instead of params are passed correctly', async () => {
        // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
        await expect(client.responses.del('resp_677efb5139a88190b512bc3fef8e535d', { path: '/_stainless_unknown_path' })).rejects.toThrow(OpenAI.NotFoundError);
    });
});
