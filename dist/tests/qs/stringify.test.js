...
describe('stringify()', function () {
    ...
    test('stringifies symbols', function () {
        ...
        expect(stringify({ a: [Symbol.iterator] }, { encodeValuesOnly: true, arrayFormat: 'brackets' })).toBe('a[]=Symbol%28Symbol.iterator%29');
    });
    test('stringifies bigints', function () {
        ...
        expect(stringify({ a: [three] }, { encodeValuesOnly: true, encoder: encodeWithN, arrayFormat: 'brackets' })).toBe('a[]=3n');
    });
    test('encodes dot in key of object when encodeDotInKeys and allowDots is provided', function () {
        expect(stringify({ 'name.obj': { first: 'John', last: 'Doe' } }, { allowDots: false, encodeDotInKeys: false })).toBe('name.obj%5Bfirst%5D=John&name.obj%5Blast%5D=Doe');
        expect(stringify({ 'name.obj': { first: 'John', last: 'Doe' } }, { allowDots: true, encodeDotInKeys: false })).toBe('name.obj.first=John&name.obj.last=Doe');
        expect(stringify({ 'name.obj': { first: 'John', last: 'Doe' } }, { allowDots: false, encodeDotInKeys: true })).toBe('name%252Eobj%5Bfirst%5D=John&name%252Eobj%5Blast%5D=Doe');
        expect(stringify({ 'name.obj': { first: 'John', last: 'Doe' } }, { allowDots: true, encodeDotInKeys: true })).toBe('name%252Eobj.first=John&name%252Eobj.last=Doe');
        // st.equal(
        // 	stringify(
        ...
        // );
        expect(stringify({ 'name.obj.subobject': { 'first.godly.name': 'John', last: 'Doe' } }, { allowDots: false, encodeDotInKeys: false })).toBe('name.obj.subobject%5Bfirst.godly.name%5D=John&name.obj.subobject%5Blast%5D=Doe');
        expect(stringify({ 'name.obj.subobject': { 'first.godly.name': 'John', last: 'Doe' } }, { allowDots: true, encodeDotInKeys: false })).toBe('name.obj.subobject.first.godly.name=John&name.obj.subobject.last=Doe');
        expect(stringify({ 'name.obj.subobject': { 'first.godly.name': 'John', last: 'Doe' } }, { allowDots: false, encodeDotInKeys: true })).toBe('name%252Eobj%252Esubobject%5Bfirst.godly.name%5D=John&name%252Eobj%252Esubobject%5Blast%5D=Doe');
        expect(stringify({ 'name.obj.subobject': { 'first.godly.name': 'John', last: 'Doe' } }, { allowDots: true, encodeDotInKeys: true })).toBe('name%252Eobj%252Esubobject.first%252Egodly%252Ename=John&name%252Eobj%252Esubobject.last=Doe');
    });
    test('should encode dot in key of object, and automatically set allowDots to `true` when encodeDotInKeys is true and allowDots in undefined', function () {
        ...
        // );
        expect(stringify({ 'name.obj.subobject': { 'first.godly.name': 'John', last: 'Doe' } }, { encodeDotInKeys: true })).toBe('name%252Eobj%252Esubobject.first%252Egodly%252Ename=John&name%252Eobj%252Esubobject.last=Doe');
    });
    test('should encode dot in key of object when encodeDotInKeys and allowDots is provided, and nothing else when encodeValuesOnly is provided', function () {
        ...
        // );
        expect(stringify({ 'name.obj': { first: 'John', last: 'Doe' } }, {
            encodeDotInKeys: true,
            allowDots: true,
            encodeValuesOnly: true,
        ...
        // );
        expect(stringify({ 'name.obj.subobject': { 'first.godly.name': 'John', last: 'Doe' } }, { allowDots: true, encodeDotInKeys: true, encodeValuesOnly: true })).toBe('name%2Eobj%2Esubobject.first%2Egodly%2Ename=John&name%2Eobj%2Esubobject.last=Doe');
    });
    ...
    test('stringifies an array value', function () {
        ...
        // 	'default => indices',
        // );
        expect(stringify({ a: ['b', 'c', 'd'] }, { arrayFormat: 'indices' })).toBe('a%5B0%5D=b&a%5B1%5D=c&a%5B2%5D=d');
        expect(stringify({ a: ['b', 'c', 'd'] }, { arrayFormat: 'brackets' })).toBe('a%5B%5D=b&a%5B%5D=c&a%5B%5D=d');
        expect(stringify({ a: ['b', 'c', 'd'] }, { arrayFormat: 'comma' })).toBe('a=b%2Cc%2Cd');
        expect(stringify({ a: ['b', 'c', 'd'] }, { arrayFormat: 'comma', commaRoundTrip: true })).toBe('a=b%2Cc%2Cd');
    ...
    test('allowEmptyArrays + strictNullHandling', function () {
        ...
        // 	'testEmptyArray[]',
        // );
        expect(stringify({ testEmptyArray: [] }, { strictNullHandling: true, allowEmptyArrays: true })).toBe('testEmptyArray[]');
    });
    describe('stringifies an array value with one item vs multiple items', function () {
        ...
        test('array with a single item', function () {
            ...
            expect(stringify({ a: ['c'] }, { encodeValuesOnly: true, arrayFormat: 'brackets' })).toBe('a[]=c');
            expect(stringify({ a: ['c'] }, { encodeValuesOnly: true, arrayFormat: 'comma' })).toBe('a=c');
            expect(stringify({ a: ['c'] }, { encodeValuesOnly: true, arrayFormat: 'comma', commaRoundTrip: true })).toBe('a[]=c');
    ...
    test('stringifies a nested array value with dots notation', function () {
        ...
        // );
        expect(stringify({ a: { b: ['c', 'd'] } }, { allowDots: true, encodeValuesOnly: true, arrayFormat: 'indices' })).toBe('a.b[0]=c&a.b[1]=d');
        expect(stringify({ a: { b: ['c', 'd'] } }, { allowDots: true, encodeValuesOnly: true, arrayFormat: 'brackets' })).toBe('a.b[]=c&a.b[]=d');
        expect(stringify({ a: { b: ['c', 'd'] } }, { allowDots: true, encodeValuesOnly: true, arrayFormat: 'comma' })).toBe('a.b=c,d');
        expect(stringify({ a: { b: ['c', 'd'] } }, { allowDots: true, encodeValuesOnly: true })).toBe('a.b[0]=c&a.b[1]=d');
    });
    test('stringifies an object inside an array', function () {
        ...
        // 	'default => indices',
        // );
        expect(stringify({ a: [{ b: 'c' }] }, { arrayFormat: 'indices', encodeValuesOnly: true })).toBe('a[0][b]=c');
        expect(stringify({ a: [{ b: 'c' }] }, { arrayFormat: 'repeat', encodeValuesOnly: true })).toBe('a[b]=c');
        expect(stringify({ a: [{ b: 'c' }] }, { arrayFormat: 'brackets', encodeValuesOnly: true })).toBe('a[][b]=c');
        ...
        // 	'default => indices',
        // );
        expect(stringify({ a: [{ b: { c: [1] } }] }, { arrayFormat: 'indices', encodeValuesOnly: true })).toBe('a[0][b][c][0]=1');
        expect(stringify({ a: [{ b: { c: [1] } }] }, { arrayFormat: 'repeat', encodeValuesOnly: true })).toBe('a[b][c]=1');
        expect(stringify({ a: [{ b: { c: [1] } }] }, { arrayFormat: 'brackets', encodeValuesOnly: true })).toBe('a[][b][c][]=1');
    ...
    test('stringifies an array with mixed objects and primitives', function () {
        ...
        // 	'default => indices',
        // );
        expect(stringify({ a: [{ b: 1 }, 2, 3] }, { encodeValuesOnly: true, arrayFormat: 'indices' })).toBe('a[0][b]=1&a[1]=2&a[2]=3');
        expect(stringify({ a: [{ b: 1 }, 2, 3] }, { encodeValuesOnly: true, arrayFormat: 'brackets' })).toBe('a[][b]=1&a[]=2&a[]=3');
    ...
    test('stringifies an object inside an array with dots notation', function () {
        ...
        // 	'default => indices',
        // );
        expect(stringify({ a: [{ b: 'c' }] }, { allowDots: true, encode: false, arrayFormat: 'indices' })).toBe('a[0].b=c');
        expect(stringify({ a: [{ b: 'c' }] }, { allowDots: true, encode: false, arrayFormat: 'brackets' })).toBe('a[].b=c');
        ...
        // 	'default => indices',
        // );
        expect(stringify({ a: [{ b: { c: [1] } }] }, { allowDots: true, encode: false, arrayFormat: 'indices' })).toBe('a[0].b.c[0]=1');
        expect(stringify({ a: [{ b: { c: [1] } }] }, { allowDots: true, encode: false, arrayFormat: 'brackets' })).toBe('a[].b.c[]=1');
    ...
    test('non-circular duplicated references can still work', function () {
        ...
        // 	'filters[$and][function]=gte&filters[$and][arguments][function]=hour_of_day&filters[$and][arguments]=0&filters[$and][function]=lte&filters[$and][arguments][function]=hour_of_day&filters[$and][arguments]=23',
        // );
        expect(stringify({ filters: { $and: [p1, p2] } }, { encodeValuesOnly: true, arrayFormat: 'indices' })).toBe('filters[$and][0][function]=gte&filters[$and][0][arguments][0][function]=hour_of_day&filters[$and][0][arguments][1]=0&filters[$and][1][function]=lte&filters[$and][1][arguments][0][function]=hour_of_day&filters[$and][1][arguments][1]=23');
        expect(stringify({ filters: { $and: [p1, p2] } }, { encodeValuesOnly: true, arrayFormat: 'brackets' })).toBe('filters[$and][][function]=gte&filters[$and][][arguments][][function]=hour_of_day&filters[$and][][arguments][]=0&filters[$and][][function]=lte&filters[$and][][arguments][][function]=hour_of_day&filters[$and][][arguments][]=23');
        expect(stringify({ filters: { $and: [p1, p2] } }, { encodeValuesOnly: true, arrayFormat: 'repeat' })).toBe('filters[$and][function]=gte&filters[$and][arguments][function]=hour_of_day&filters[$and][arguments]=0&filters[$and][function]=lte&filters[$and][arguments][function]=hour_of_day&filters[$and][arguments]=23');
    });
    test('selects properties when filter=array', function () {
        ...
        // 	'default => indices',
        // );
        expect(stringify({ a: { b: [1, 2, 3, 4], c: 'd' }, c: 'f' }, { filter: ['a', 'b', 0, 2] })).toBe('a%5Bb%5D%5B0%5D=1&a%5Bb%5D%5B2%5D=3');
        expect(stringify({ a: { b: [1, 2, 3, 4], c: 'd' }, c: 'f' }, { filter: ['a', 'b', 0, 2], arrayFormat: 'indices' })).toBe('a%5Bb%5D%5B0%5D=1&a%5Bb%5D%5B2%5D=3');
        expect(stringify({ a: { b: [1, 2, 3, 4], c: 'd' }, c: 'f' }, { filter: ['a', 'b', 0, 2], arrayFormat: 'brackets' })).toBe('a%5Bb%5D%5B%5D=1&a%5Bb%5D%5B%5D=3');
    });
    ...
    test('can sort the keys at depth 3 or more too', function () {
        ...
        // );
        expect(stringify({ a: 'a', z: { zj: { zjb: 'zjb', zja: 'zja' }, zi: { zib: 'zib', zia: 'zia' } }, b: 'b' }, { sort: sort, encode: false })).toBe('a=a&b=b&z[zi][zia]=zia&z[zi][zib]=zib&z[zj][zja]=zja&z[zj][zjb]=zjb');
        expect(stringify({ a: 'a', z: { zj: { zjb: 'zjb', zja: 'zja' }, zi: { zib: 'zib', zia: 'zia' } }, b: 'b' }, { sort: null, encode: false })).toBe('a=a&z[zj][zjb]=zjb&z[zj][zja]=zja&z[zi][zib]=zib&z[zi][zia]=zia&b=b');
    });
    ...
    test('receives the default encoder as a second argument', function () {
        ...
        // 	},
        // );
        stringify({ a: 1, b: new Date(), c: true, d: [1] }, {
            encoder: function (str) {
                // st.match(typeof str, /^(?:string|number|boolean)$/);
    ...
    (typeof Buffer === 'undefined' ? test.skip : test)('can use custom encoder for a buffer object', function () {
        // st.equal(
        // 	stringify(
        // 		{ a: Buffer.from([1]) },
        // 		{
        ...
        // 	'a=b',
        // );
        expect(stringify({ a: Buffer.from([1]) }, {
            encoder: function (buffer) {
                if (typeof buffer === 'string') {
                    return buffer;
                }
        ...
        // 	'a=a b',
        // );
        expect(stringify({ a: Buffer.from('a b') }, {
            encoder: function (buffer) {
                return buffer;
            },
        })).toBe('a=a b');
    ...
    test('serializeDate option', function () {
        ...
        // );
        expect(stringify({ a: mutatedDate })).toBe('a=' + Date.prototype.toISOString.call(mutatedDate).replace(/:/g, '%3A'));
        ...
        // );
        expect(stringify({ a: specificDate }, {
            // @ts-ignore
            serializeDate: function (d) {
                return d.getTime() * 7;
            },
    ...
    test('encodeValuesOnly', function () {
        ...
        // );
        expect(stringify({ a: 'b', c: ['d', 'e=f'], f: [['g'], ['h']] }, { encodeValuesOnly: true, arrayFormat: 'indices' })).toBe('a=b&c[0]=d&c[1]=e%3Df&f[0][0]=g&f[1][0]=h');
        expect(stringify({ a: 'b', c: ['d', 'e=f'], f: [['g'], ['h']] }, { encodeValuesOnly: true, arrayFormat: 'brackets' })).toBe('a=b&c[]=d&c[]=e%3Df&f[][]=g&f[][]=h');
        expect(stringify({ a: 'b', c: ['d', 'e=f'], f: [['g'], ['h']] }, { encodeValuesOnly: true, arrayFormat: 'repeat' })).toBe('a=b&c=d&c=e%3Df&f=g&f=h');
        // st.equal(
        ...
        // );
        expect(stringify({ a: 'b', c: ['d', 'e'], f: [['g'], ['h']] }, { arrayFormat: 'indices' })).toBe('a=b&c%5B0%5D=d&c%5B1%5D=e&f%5B0%5D%5B0%5D=g&f%5B1%5D%5B0%5D=h');
        expect(stringify({ a: 'b', c: ['d', 'e'], f: [['g'], ['h']] }, { arrayFormat: 'brackets' })).toBe('a=b&c%5B%5D=d&c%5B%5D=e&f%5B%5D%5B%5D=g&f%5B%5D%5B%5D=h');
        expect(stringify({ a: 'b', c: ['d', 'e'], f: [['g'], ['h']] }, { arrayFormat: 'repeat' })).toBe('a=b&c=d&c=e&f=g&f=h');
    });
    ...
    test('`charsetSentinel` option', function () {
        ...
        // );
        expect(stringify({ a: 'æ' }, { charsetSentinel: true, charset: 'utf-8' })).toBe('utf8=%E2%9C%93&a=%C3%A6');
        // st.equal(
        // 	stringify({ a: 'æ' }, { charsetSentinel: true, charset: 'iso-8859-1' }),
        // 	'utf8=%26%2310003%3B&a=%E6',
        // 	'adds the right sentinel when instructed to and the charset is iso-8859-1',
        // );
        expect(stringify({ a: 'æ' }, { charsetSentinel: true, charset: 'iso-8859-1' })).toBe('utf8=%26%2310003%3B&a=%E6');
    });
...
describe('stringifies empty keys', function () {
    empty_test_cases.forEach(function (testCase) {
        test('stringifies an object with empty string key with ' + testCase.input, function () {
            ...
            // );
            expect(stringify(testCase.with_empty_keys, { encode: false, arrayFormat: 'indices' })).toBe(testCase.stringify_output.indices);
            expect(stringify(testCase.with_empty_keys, { encode: false, arrayFormat: 'brackets' })).toBe(testCase.stringify_output.brackets);
            expect(stringify(testCase.with_empty_keys, { encode: false, arrayFormat: 'repeat' })).toBe(testCase.stringify_output.repeat);
        });
    });
